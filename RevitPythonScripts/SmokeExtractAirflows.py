...
# MAIN SCRIPT
print("Running SmokeAirflow.py script...")

# Collect all spaces from the model:
...
# Calculate smoke extract volumes according to smoke extract strategy:
